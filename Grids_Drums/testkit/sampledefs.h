...
struct sample_t {
  ...
  char sname[20];        // sample name
	...
	Bouncerbass,	// pointer to sample array
	Bouncerbass_SIZE,	// size of the sample array
	Bouncerbass_SIZE,	//sampleindex. if at end of sample array sound is not playing
	35,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Bouncerbass",	// sample name

	Dam_fuzzywoodc3,	// pointer to sample array
	Dam_fuzzywoodc3_SIZE,	// size of the sample array
	Dam_fuzzywoodc3_SIZE,	//sampleindex. if at end of sample array sound is not playing
	36,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_fuzzywoodc3",	// sample name

	Dam_rubbafuzzc3,	// pointer to sample array
	Dam_rubbafuzzc3_SIZE,	// size of the sample array
	Dam_rubbafuzzc3_SIZE,	//sampleindex. if at end of sample array sound is not playing
	37,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_rubbafuzzc3",	// sample name

	Nrgk1arpbc3,	// pointer to sample array
	Nrgk1arpbc3_SIZE,	// size of the sample array
	Nrgk1arpbc3_SIZE,	//sampleindex. if at end of sample array sound is not playing
	38,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Nrgk1arpbc3",	// sample name

	Nrgk4obbassc3,	// pointer to sample array
	Nrgk4obbassc3_SIZE,	// size of the sample array
	Nrgk4obbassc3_SIZE,	//sampleindex. if at end of sample array sound is not playing
	39,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Nrgk4obbassc3",	// sample name

	Winer_stab,	// pointer to sample array
	Winer_stab_SIZE,	// size of the sample array
	Winer_stab_SIZE,	//sampleindex. if at end of sample array sound is not playing
	40,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Winer_stab",	// sample name

	Womp,	// pointer to sample array
	Womp_SIZE,	// size of the sample array
	Womp_SIZE,	//sampleindex. if at end of sample array sound is not playing
